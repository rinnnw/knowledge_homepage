      ...
      <CardContent className="px-6">
        <div className="space-y-5">
          {mockPopularKnowledge.map((item, index) => (
            ...
            >
              <div className="p-4 rounded-lg hover:bg-slate-100 transition-colors cursor-pointer">
                <h3 className="font-medium text-lg mb-3 hover:text-primary transition-colors">{item.title}</h3>
        ...
        <div className="mt-6 text-center">
          ...
          >
            <button className="text-sm text-primary hover:underline px-4 py-2">查看更多热门知识</button>
          </motion.div>
        </div>
      </CardContent>
    </Card>
