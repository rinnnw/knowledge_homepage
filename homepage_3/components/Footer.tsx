  ...
  return (
    <FooterContainer>
      <FooterContent>
        ...
        <FooterLinks>
          <FooterLinkGroup>
            ...
            <FooterLink href="/about">平台介绍</FooterLink>
          ...
          <FooterLinkGroup>
            ...
            <FooterLink href="/help">使用指南</FooterLink>
      ...
      <FooterBottom>
        ...
        <FooterPolicies>
          <FooterPolicyLink href="/terms">服务条款</FooterPolicyLink>
          <FooterPolicyLink href="/privacy">隐私政策</FooterPolicyLink>
        </FooterPolicies>
      </FooterBottom>
    </FooterContainer>
  )
